...
export default function PayrollFunc(props: payrollprops) {
  ...
  var arrayOfEndpoints = ["https://mejiapayrollapi.yk3music.com"]
...
<meta property="og:image" content="https://payroll.mejiaforcontroller.com/2022-payroll-thumb.png"></meta>
          ...
          <meta name="twitter:image" key='twitterimg' content="https://payroll.mejiaforcontroller.com/2022-payroll-thumb.png"></meta>
...
loadedfirsttimeref.current === false && (
  <div className='items-center mx-auto sm:ml-8 text-lg px-3 py-3 text-white flex flex-row gap-x-2'>
    <svg className="animate-spin h-5 w-5 mr-3 ..." viewBox="0 0 24 24">
    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
  </svg>
  <p>A corgi is fetching your data, it's loading!</p>
  </div>
